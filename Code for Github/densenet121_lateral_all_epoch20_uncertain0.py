...
with open("densenet121_lateral_all_epoch20_uncertain0_accuracy.txt", "w") as output:
    output.write(str(accuracyt))

history = history.history

with open("densenet121_lateral_all_epoch20_uncertain0_history.txt", "w") as output:
