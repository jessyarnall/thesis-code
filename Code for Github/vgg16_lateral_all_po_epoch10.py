...
df = pd.read_csv("/home/jyarnal1/lateral_all_po.csv", header=0, sep=',')
...
with open("vgg16_lateral_all_po_epoch10_accuracy_v3.txt", "w") as output:
    output.write(str(accuracyt))

history = history.history

with open("vgg16_lateral_all_po_epoch10_history_v3.txt", "w") as output:
...
with open("vgg16_lateral_all_po_epoch10_cm_v3.txt", "w") as output:
    output.write(str(cm))
