...
df = pd.read_csv("/home/jyarnal1/lateral_all_ec.csv", header=0, sep=',')
...
with open("vgg16_lateral_all_ec_epoch10_accuracy_v2.txt", "w") as output:
    output.write(str(accuracyt))

history = history.history

with open("vgg16_lateral_all_ec_epoch10_history_v2.txt", "w") as output:
...
with open("vgg16_lateral_all_ec_epoch10_cm_v2.txt", "w") as output:
    output.write(str(cm))
