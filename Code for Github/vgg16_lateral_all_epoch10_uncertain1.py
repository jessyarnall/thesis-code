...
with open("vgg16_lateral_all_epoch10_uncertain1_accuracy.txt", "w") as output:
    output.write(str(accuracyt))

history = history.history

with open("vgg16_lateral_all_epoch10_uncertain1_history.txt", "w") as output:
