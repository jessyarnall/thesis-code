...
with open("vgg16_lateral_all_epoch10_uncertain0_sigmoid_accuracy.txt", "w") as output:
    output.write(str(accuracyt))

history = history.history

with open("vgg16_lateral_all_epoch10_uncertain0_sigmoid_history.txt", "w") as output:
